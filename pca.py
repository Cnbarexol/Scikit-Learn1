...
from sklearn.decomposition import PCA #importamos algoritmo PCA
...
if __name__ == '__main__':
    ...
    print(dt_heart.head(5)) #imprimo los 5 primeros 5 numeros
    dt_features=dt_heart.drop(['INDICENCIA'],axis=1) #las featurus sin el target
    dt_target = dt_heart ['INCIDENCIA'] #obtenemos el target
    
    dt_features = StandardScaler().fit_transform(dt_features) #Normalizaos los datos
